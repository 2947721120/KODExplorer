...
ace.define("ace/worker/mirror", ["require", "exports", "module", "ace/document", "ace/lib/lang"],
function(e, t, n) {
    "use strict";
...
ace.define("ace/mode/html/saxparser", ["require", "exports", "module"],
function(e, t, n) {
    n.exports = function r(t, n, i) {
        ...
        2 : [function(e, t, n) {
            ...
            f.consumeEntity = function(e, t, n) {
                ...
                if (c === i.EOF) return ! 1;
                l += c;
                if (c == "	" || c == "\n" || c == "" || c == " " || c == "<" || c == "&") return e.unget(l),
                !1;
                if (n === c) return e.unget(l),
                !1;
                if (c == "#") {
                    c = e.shift(1);
                    if (c === i.EOF) return t._parseError("expected-numeric-entity-but-got-eof"),
                    e.unget(l),
                    !1;
                    l += c;
                    var h = 10,
                    ...
                    if (p(c)) {
                        ...
                        return c !== ";" && (t._parseError("numeric-entity-without-semicolon"), e.unget(c)),
                        f
                    }
                    return e.unget(l),
            ...
            r.prototype = {
                ...
                matchWhile: function(e) {
                    ...
                    if (n) {
                        ...
                        return this.advance(n[0].length),
                        n[0]
                    }
                    return ""
                },
                ...
                shift: function(e) {
                    ...
                    return this.advance(Math.min(e, this.data.length - this.start)),
                    t
                },
                peek: function(e) {
                    if (!this.eof && this.start + e >= this.data.length) throw r.DRAIN;
        ...
        5 : [function(e, t, n) {
            ...
            u.prototype._emitToken = function(e) {
                ...
                e.type === "StartTag" && e.selfClosing && !this._tokenHandler.isSelfClosingFlagAcknowledged() && this._parseError("non-void-element-with-trailing-solidus", {
                    name: e.name
                })
            },
            ...
            u.prototype.tokenize = function(e) {
                ...
                function f(e) {
                    ...
                    else if (n === "\0") t._parseError("invalid-codepoint"),
                    t._emitToken({
                        type: "Characters",
                        data: "\ufffd"
                    }),
                ...
                function h(e) {
                    ...
                    !1;
                    if (n === "\0") t._parseError("invalid-codepoint"),
                    t._emitToken({
                        type: "Characters",
                        data: "\ufffd"
                    }),
                ...
                function x(e) {
                    ...
                    return n === "-" ? (t._emitToken({
                        type: "Characters",
                        data: "-"
                    }), t.setState(T)) : (e.unget(n), t.setState(p)),
                    !0
                }
                function T(e) {
                    var n = e.char();
                    return n === "-" ? (t._emitToken({
                        type: "Characters",
                        data: "-"
                    }), t.setState(k)) : (e.unget(n), t.setState(p)),
                    !0
                }
                function N(e) {
                    var i = e.char();
                    if (i === r.EOF) e.unget(i),
                    t.setState(n);
                    ...
                    else if (i === "\0") t._parseError("invalid-codepoint"),
                    t._emitToken({
                        type: "Characters",
                        data: "\ufffd"
                    }),
                ...
                function M(e) {
                    ...
                    return s(n) || n === "/" || n === ">" ? (t._emitToken({
                        ...
                        type: "Characters",
                        data: n
                    }), this._temporaryBuffer += n, e.commit()) : (e.unget(n), t.setState(N)),
                    !0
                }
                function _(e) {
                    var i = e.char();
                ...
                function H(e) {
                    ...
                    return n === "/" ? (t._emitToken({
                        type: "Characters",
                        data: "/"
                    }), this._temporaryBuffer = "", t.setState(B)) : (e.unget(n), t.setState(_)),
                    !0
                }
                function B(e) {
                    var n = e.char();
                    return s(n) || n === "/" || n === ">" ? (t._emitToken({
                        ...
                        type: "Characters",
                        data: n
                    }), this._temporaryBuffer += n, e.commit()) : (e.unget(n), t.setState(_)),
                    !0
                }
                function j(e) {
                    var i = e.char();
                ...
                function F(e) {
                    ...
                    t.setState(I)) : i === ">" ? (t._parseError("expected-closing-tag-but-got-right-bracket"), t.setState(n)) : (t._parseError("expected-closing-tag-but-got-char", {
                        data: i
                    }), e.unget(i), t.setState(Q)),
                    !0
                }
                function I(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-tag-name"), e.unget(i), t.setState(n)) : s(i) ? t.setState(q) : o(i) ? t._currentToken.name += i.toLowerCase() : i === ">" ? t._emitCurrentToken() : i === "/" ? t.setState(K) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.name += "\ufffd") : t._currentToken.name += i,
                    e.commit(),
                    !0
                }
                function q(e) {
                    var i = e.char();
                    if (i === r.EOF) t._parseError("expected-attribute-name-but-got-eof"),
                    e.unget(i),
                    t.setState(n);
                    else {
                        if (s(i)) return ! 0;
                ...
                function U(e) {
                    var i = e.char();
                    if (i === r.EOF) t._parseError("expected-end-of-tag-but-got-eof"),
                    e.unget(i),
                    t.setState(n);
                    else {
                        if (s(i)) return ! 0;
                ...
                function z(e) {
                    var i = e.char();
                    if (i === r.EOF) t._parseError("expected-attribute-value-but-got-eof"),
                    e.unget(i),
                    t.setState(n);
                    else {
                        if (s(i)) return ! 0;
                ...
                function W(e) {
                    var i = e.char();
                    if (i === r.EOF) t._parseError("eof-in-attribute-value-double-quote"),
                    e.unget(i),
                    t.setState(n);
                    else if (i === '"') t.setState(J);
                    else if (i === "&") this._additionalAllowedCharacter = '"',
                    t.setState($);
                    else if (i === "\0") t._parseError("invalid-codepoint"),
                ...
                function X(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-attribute-value-single-quote"), e.unget(i), t.setState(n)) : i === "'" ? t.setState(J) : i === "&" ? (this._additionalAllowedCharacter = "'", t.setState($)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentAttribute().nodeValue += "\ufffd") : t._currentAttribute().nodeValue += i + e.matchUntil("\0|['&]"),
                    !0
                }
                function V(e) {
                    var i = e.char();
                    if (i === r.EOF) t._parseError("eof-after-attribute-value"),
                    e.unget(i),
                    t.setState(n);
                    ...
                    else if (i === '"' || i === "'" || i === "=" || i === "`" || i === "<") t._parseError("unexpected-character-in-unquoted-attribute-value"),
                    t._currentAttribute().nodeValue += i,
                    e.commit();
                    else if (i === "\0") t._parseError("invalid-codepoint"),
                    t._currentAttribute().nodeValue += "\ufffd";
                ...
                function $(e) {
                    ...
                    return this._currentAttribute().nodeValue += n || "&",
                    this._additionalAllowedCharacter === '"' ? t.setState(W) : this._additionalAllowedCharacter === "'" ? t.setState(X) : this._additionalAllowedCharacter === ">" && t.setState(V),
                    !0
                }
                function J(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-after-attribute-value"), e.unget(i), t.setState(n)) : s(i) ? t.setState(q) : i === ">" ? (t.setState(n), t._emitCurrentToken()) : i === "/" ? t.setState(K) : (t._parseError("unexpected-character-after-attribute-value"), e.unget(i), t.setState(q)),
                    !0
                }
                function K(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("unexpected-eof-after-solidus-in-tag"), e.unget(i), t.setState(n)) : i === ">" ? (t._currentToken.selfClosing = !0, t.setState(n), t._emitCurrentToken()) : (t._parseError("unexpected-character-after-solidus-in-tag"), e.unget(i), t.setState(q)),
                    !0
                }
                function Q(e) {
                    var r = e.matchUntil(">");
                ...
                function G(e) {
                    ...
                    t.setState(Z);
                        ...
                        var i = e.shift(5);
                        if (i === r.EOF || n === r.EOF) return t._parseError("expected-dashes-or-doctype"),
                        t.setState(Q),
                        e.unget(n),
                        !0;
                        n += i,
                        n.toUpperCase() === "DOCTYPE" ? (t._currentToken = {
                            type: "Doctype",
                            name: "",
                            publicId: null,
                            systemId: null,
                ...
                function Z(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-comment"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(et) : i === ">" ? (t._parseError("incorrect-comment"), t._emitToken(t._currentToken), t.setState(n)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "\ufffd") : (t._currentToken.data += i, t.setState(tt)),
                    !0
                }
                function et(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-comment"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(rt) : i === ">" ? (t._parseError("incorrect-comment"), t._emitToken(t._currentToken), t.setState(n)) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "\ufffd") : (t._currentToken.data += "-" + i, t.setState(tt)),
                    !0
                }
                function tt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-comment"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(nt) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "\ufffd") : (t._currentToken.data += i, e.commit()),
                    !0
                }
                function nt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-comment-end-dash"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === "-" ? t.setState(rt) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "-\ufffd", t.setState(tt)) : (t._currentToken.data += "-" + i + e.matchUntil("\0|-"), e.char()),
                    !0
                }
                function rt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-comment-double-dash"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === ">" ? (t._emitToken(t._currentToken), t.setState(n)) : i === "!" ? (t._parseError("unexpected-bang-after-double-dash-in-comment"), t.setState(it)) : i === "-" ? (t._parseError("unexpected-dash-after-double-dash-in-comment"), t._currentToken.data += i) : i === "\0" ? (t._parseError("invalid-codepoint"), t._currentToken.data += "--\ufffd", t.setState(tt)) : (t._parseError("unexpected-char-in-comment"), t._currentToken.data += "--" + i, t.setState(tt)),
                    !0
                }
                function it(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-comment-end-bang-state"), t._emitToken(t._currentToken), e.unget(i), t.setState(n)) : i === ">" ? (t._emitToken(t._currentToken), t.setState(n)) : i === "-" ? (t._currentToken.data += "--!", t.setState(nt)) : (t._currentToken.data += "--!" + i, t.setState(tt)),
                    !0
                }
                function st(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("expected-doctype-name-but-got-eof"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) ? t.setState(ot) : (t._parseError("need-space-after-doctype"), e.unget(i), t.setState(ot)),
                    !0
                }
                function ot(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("expected-doctype-name-but-got-eof"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) || (i === ">" ? (t._parseError("expected-doctype-name-but-got-right-bracket"), t._currentToken.forceQuirks = !0, t.setState(n), t._emitCurrentToken()) : (o(i) && (i = i.toLowerCase()), t._currentToken.name = i, t.setState(ut))),
                    !0
                }
                function ut(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._currentToken.forceQuirks = !0, e.unget(i), t._parseError("eof-in-doctype-name"), t.setState(n), t._emitCurrentToken()) : s(i) ? t.setState(at) : i === ">" ? (t.setState(n), t._emitCurrentToken()) : (o(i) && (i = i.toLowerCase()), t._currentToken.name += i, e.commit()),
                    !0
                }
                function at(e) {
                    var i = e.char();
                    if (i === r.EOF) t._currentToken.forceQuirks = !0,
                    e.unget(i),
                    t._parseError("eof-in-doctype"),
                    t.setState(n),
                    t._emitCurrentToken();
                    else if (!s(i)) if (i === ">") t.setState(n),
                    t._emitCurrentToken();
                    else {
                        if (["p", "P"].indexOf(i) > -1) {
                            ...
                            if (u) return t.setState(vt),
                            !0
                        }
                        e.unget(i),
                        t._currentToken.forceQuirks = !0,
                        i === r.EOF ? (t._parseError("eof-in-doctype"), e.unget(i), t.setState(n), t._emitCurrentToken()) : (t._parseError("expected-space-or-right-bracket-in-doctype", {
                            data: i
                        }), t.setState(wt))
                    }
                    return ! 0
                ...
                function ft(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) ? t.setState(lt) : i === "'" || i === '"' ? (t._parseError("unexpected-char-in-doctype"), e.unget(i), t.setState(lt)) : (e.unget(i), t.setState(lt)),
                    !0
                }
                function lt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : s(i) || (i === '"' ? (t._currentToken.publicId = "", t.setState(ct)) : i === "'" ? (t._currentToken.publicId = "", t.setState(ht)) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t.setState(n), t._emitCurrentToken()) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt))),
                    !0
                }
                function ct(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, e.unget(i), t.setState(n), t._emitCurrentToken()) : i === '"' ? t.setState(pt) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t.setState(n), t._emitCurrentToken()) : t._currentToken.publicId += i,
                    !0
                }
                function ht(e) {
                    var i = e.char();
                ...
                function pt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) ? t.setState(dt) : i === ">" ? (t.setState(n), t._emitCurrentToken()) : i === '"' ? (t._parseError("unexpected-char-in-doctype"), t._currentToken.systemId = "", t.setState(gt)) : i === "'" ? (t._parseError("unexpected-char-in-doctype"), t._currentToken.systemId = "", t.setState(yt)) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt)),
                    !0
                }
                function dt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) || (i === ">" ? (t._emitCurrentToken(), t.setState(n)) : i === '"' ? (t._currentToken.systemId = "", t.setState(gt)) : i === "'" ? (t._currentToken.systemId = "", t.setState(yt)) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt))),
                    !0
                }
                function vt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) ? t.setState(mt) : i === "'" || i === '"' ? (t._parseError("unexpected-char-in-doctype"), e.unget(i), t.setState(mt)) : (e.unget(i), t.setState(mt)),
                    !0
                }
                function mt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) || (i === '"' ? (t._currentToken.systemId = "", t.setState(gt)) : i === "'" ? (t._currentToken.systemId = "", t.setState(yt)) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), t.setState(n)) : (t._parseError("unexpected-char-in-doctype"), t._currentToken.forceQuirks = !0, t.setState(wt))),
                    !0
                }
                function gt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : i === '"' ? t.setState(bt) : i === ">" ? (t._parseError("unexpected-end-of-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), t.setState(n)) : t._currentToken.systemId += i,
                    !0
                }
                function yt(e) {
                    var i = e.char();
                ...
                function bt(e) {
                    var i = e.char();
                    return i === r.EOF ? (t._parseError("eof-in-doctype"), t._currentToken.forceQuirks = !0, t._emitCurrentToken(), e.unget(i), t.setState(n)) : s(i) || (i === ">" ? (t._emitCurrentToken(), t.setState(n)) : (t._parseError("unexpected-char-in-doctype"), t.setState(wt))),
                    !0
                }
                function wt(e) {
                    var i = e.char();
                    return i === r.EOF ? (e.unget(i), t._emitCurrentToken(), t.setState(n)) : i === ">" && (t._emitCurrentToken(), t.setState(n)),
                    !0
                }
                u.DATA = n,
                u.RCDATA = f,
        ...
        6 : [function(e, t, n) {
            ...
            function g() {
                ...
                t.base = {
                    ...
                    processEOF: function() {
                        ...
                        e.openElements.length > 2 ? e.parseError("expected-closing-tag-but-got-eof") : e.openElements.length == 2 && e.openElements.item(1).localName != "body" ? e.parseError("expected-closing-tag-but-got-eof") : e.context && e.openElements.length > 1
                    },
                ...
                t.beforeHTML.startTagHtml = function(t, n, r) {
                    e.insertHtmlElement(n),
                    e.setInsertionMode("beforeHead")
                },
                ...
                t.afterAfterBody.processCharacters = function(n) {
                    if (!p(n.characters)) return e.parseError("unexpected-char-after-body"),
                    e.setInsertionMode("inBody"),
                ...
                t.beforeHead.startTagHead = function(t, n) {
                    e.insertHeadElement(n),
                    e.setInsertionMode("inHead")
                },
                ...
                t.inHead.processEOF = function() {
                    var t = e.currentStackItem().localName; ["title", "style", "script"].indexOf(t) != -1 && (e.parseError("expected-named-closing-tag-but-got-eof", {
                        name: t
                    }), e.popElement()),
                    this.anythingElse(),
                    e.insertionMode.processEOF()
                ...
                t.inBody.startTagHeading = function(t, n) {
                    e.openElements.inButtonScope("p") && this.endTagP("p"),
                    e.currentStackItem().isNumberedHeader() && (e.parseError("unexpected-start-tag", {
                        name: t
                    }), e.popElement()),
                    e.insertElement(t, n)
                },
                t.inBody.startTagA = function(t, n) {
                    ...
                    r && (e.parseError("unexpected-start-tag-implies-end-tag", {
                        startName: "a",
                        endName: "a"
                    }), e.adoptionAgencyEndTag("a"), e.openElements.contains(r) && e.openElements.remove(r), e.removeElementFromActiveFormattingElements(r)),
                    e.reconstructActiveFormattingElements(),
                ...
                t.inBody.startTagNobr = function(t, n) {
                    e.reconstructActiveFormattingElements(),
                    e.openElements.inScope("nobr") && (e.parseError("unexpected-start-tag-implies-end-tag", {
                        startName: "nobr",
                        endName: "nobr"
                    }), this.processEndTag("nobr"), e.reconstructActiveFormattingElements()),
                    e.insertFormattingElement(t, n)
                },
                ...
                t.inBody.endTagOther = function(t) {
                    ...
                    for (var r = e.openElements.length - 1; r > 0; r--) {
                        ...
                        if (n.localName == t) {
                            ...
                            e.currentStackItem().localName != t && e.parseError("unexpected-end-tag", {
                                name: t
                            }),
                ...
                t.inBody.endTagForm = function(t) {
                    var n = e.form;
                    e.form = null,
                    !n || !e.openElements.inScope(t) ? e.parseError("unexpected-end-tag", {
                        name: t
                ...
                t.inBody.endTagHeading = function(t) {
                    ...
                    e.generateImpliedEndTags(),
                    e.currentStackItem().localName != t && e.parseError("end-tag-too-early", {
                        name: t
                    }),
                    e.openElements.remove_openElements_until(function(e) {
                ...
                t.inForeignContent.processStartTag = function(t, n, r) {
                    ...
                    e.currentStackItem().namespaceURI == "http://www.w3.org/1998/Math/MathML" && (n = e.adjustMathMLAttributes(n)),
                    e.currentStackItem().namespaceURI == "http://www.w3.org/2000/svg" && (t = e.adjustSVGTagNameCase(t), n = e.adjustSVGAttributes(n)),
                    n = e.adjustForeignAttributes(n),
                ...
                t.inFrameset.endTagFrameset = function(t, n) {
                    e.currentStackItem().localName == "html" ? e.parseError("unexpected-frameset-in-frameset-innerhtml") : e.popElement(),
                ...
                t.inTable.processCharacters = function(n) {
                    if (e.currentStackItem().isFosterParenting()) {
                        ...
                        e.insertionMode.processCharacters(n)
                    } else e.redirectAttachToFosterParent = !0,
                    t.inBody.processCharacters(n),
                ...
                t.inTableText.flushCharacters = function() {
                    ...
                    p(t) ? e.insertText(t) : (e.redirectAttachToFosterParent = !0, e.reconstructActiveFormattingElements(), e.insertText(t), e.framesetOk = !1, e.redirectAttachToFosterParent = !1),
                ...
                t.inSelect.endTagOptgroup = function(t) {
                    e.currentStackItem().localName == "option" && e.openElements.item(e.openElements.length - 2).localName == "optgroup" && e.popElement(),
                    e.currentStackItem().localName == "optgroup" ? e.popElement() : e.parseError("unexpected-end-tag-in-select", {
                        name: "optgroup"
                    })
                },
                ...
                t.inSelect.startTagInput = function(t, n) {
                    ...
                    e.openElements.inSelectScope("select") && (this.endTagSelect("select"), e.insertionMode.processStartTag(t, n))
                },
            ...
            function y(e, t) {
                return e.replace(new RegExp("{[0-9a-z-]+}", "gi"),
                function(e) {
            ...
            m.prototype.takeLeadingWhitespace = function() {
                var e = this.current;
                return this.skipLeadingWhitespace(),
            ...
            g.prototype.adoptionAgencyEndTag = function(e) {
                ...
                while (s++<t) {
                    ...
                    if (!o) return this.openElements.remove_openElements_until(i),
                    this.removeElementFromActiveFormattingElements(r),
                    !0;
            ...
            g.prototype.processToken = function(e) {
                ...
                n; ! t || !t.isForeign() || t.isMathMLTextIntegrationPoint() && (e.type == "StartTag" && !(e.name in {
                    mglyph: 0,
                    malignmark: 0
            ...
            g.prototype.insertHtmlElement = function(e) {
                ...
                return this.attachNode(t, this.document),
            ...
            g.prototype.insertHeadElement = function(e) {
                ...
                return this.head = new f("http://www.w3.org/1999/xhtml", "head", e, t),
            ...
            g.prototype.insertBodyElement = function(e) {
                ...
                return this.attachNode(t, this.openElements.top.node),
            ...
            g.prototype.insertElement = function(e, t, n, r) {
                ...
                this.shouldFosterParent() ? this.insertIntoFosterParent(i) : this.attachNode(i, this.openElements.top.node),
            ...
            g.prototype.resetInsertionMode = function() {
                ...
                for (var n = this.openElements.length - 1; n >= 0; n--) {
                    ...
                    n === 0 && (r.ok(this.context), e = !0, t = new f("http://www.w3.org/1999/xhtml", this.context, [], null));
        ...
        8 : [function(e, t, n) {
            t.exports = {
                "null-character": "在输入流空字符替换 U+FFFD.",
                "invalid-codepoint": "在流无效代码点",
                "incorrectly-placed-solidus": "固相线 (/) 不正确地放置在标签.",
                "incorrect-cr-newline-entity": "不正确CR换行实体，以取代LF.",
                "illegal-windows-1252-entity": "非法数字（窗口1252参考）用于实体.",
                "cant-convert-numeric-entity": "数字实体无法转换为字符(代码点 U+{charAsInt}).",
                "invalid-numeric-entity-replaced": "数字实体表示了非法代码点。扩展到C1的控制范围.",
                "numeric-entity-without-semicolon": "数字实体并没有结束于 ';'.",
                "expected-numeric-entity-but-got-eof": "数字实体。出现文件结束，而不是.",
                "expected-numeric-entity": "数字实体，但未发现.",
                "named-entity-without-semicolon": "命名实体未以结束 ';'.",
                "expected-named-entity": "命名实体的预期。没有了.",
                "attributes-in-end-tag": "结束标记包含非预期的属性.",
                "self-closing-flag-on-end-tag": "结束标记包含意外自闭标志.",
                "bare-less-than-sign-at-eof": "文件结束后， <.",
                "expected-tag-name-but-got-right-bracket": "应为标记名称。 得到 '>' 代替.",
                "expected-tag-name-but-got-question-mark": "应为标记名称。 得到 '?' 代替。 (HTML不支持处理指令。)",
                "expected-tag-name": "应为标记名称。有别的东西来代替.",
                "expected-closing-tag-but-got-right-bracket": "预计结束标记。 得到 '>' 代替。忽略 '</>'.",
                "expected-closing-tag-but-got-eof": "预计结束标记。文件意外结束.",
                "expected-closing-tag-but-got-char": "预计结束标记。意外的字符 '{data}' 发现.",
                "eof-in-tag-name": "在标记名称文件意外结束.",
                "expected-attribute-name-but-got-eof": "意外的文件结尾。应为属性名称.",
                "eof-in-attribute-name": "在属性名称的文件意外结束.",
                "invalid-character-in-attribute-name": "在属性名无效字符.",
                "duplicate-attribute": "下降重复的属性 '{name}'标签上....",
                "expected-end-of-tag-but-got-eof": "意外的文件结尾。预期值=或标记的结束.",
                "expected-attribute-value-but-got-eof": "意外的文件结尾。预计属性值.",
                "expected-attribute-value-but-got-right-bracket": "预计属性值。 得到 '>' instead.",
                "unexpected-character-in-unquoted-attribute-value": "意外 人物在不带引号的属性",
                "invalid-character-after-attribute-name": "属性名后意外的字符.",
                "unexpected-character-after-attribute-value": "意外 character after attribute value.",
                "eof-in-attribute-value-double-quote": '意外 文件结束 在属性值 (").',
                "eof-in-attribute-value-single-quote": "意外 文件结束 在属性值 (').",
                "eof-in-attribute-value-no-quotes": "意外 文件结束 在属性值.",
                "eof-after-attribute-value": "意外 文件结束 属性值后.",
                "unexpected-eof-after-solidus-in-tag": "意外 文件结束 in tag. Expected >.",
                "unexpected-character-after-solidus-in-tag": "意外 字符之后 / 在标签.预期 >.",
                "expected-dashes-or-doctype": "Expected '--' or 'DOCTYPE'. Not found.",
                "unexpected-bang-after-double-dash-in-comment": "意外 ! after -- in comment.",
                "incorrect-comment": "不正确的评论.",
                "eof-in-comment": "意外 文件结束 in comment.",
                "eof-in-comment-end-dash": "意外 文件结束 in comment (-).",
                "unexpected-dash-after-double-dash-in-comment": "意外 '-' after '--' found in comment.",
                "eof-in-comment-double-dash": "在注释文件意外结束 (--).",
                "eof-in-comment-end-bang-state": "意外 文件结束 in comment.",
                "unexpected-char-in-comment": "在注释意外发现字.",
                "need-space-after-doctype": "文字字符串后无空间 'DOCTYPE'.",
                "expected-doctype-name-but-got-right-bracket": "意外 > 字符.预计DOCTYPE名.",
                "expected-doctype-name-but-got-eof": "文件的字面stringUnexpected结束后没有空格。预计DOCTYPE名....",
                "eof-in-doctype-name": "在DOCTYPE名文件意外结束.",
                "eof-in-doctype": "在DOCTYPE文件意外结束.",
                "expected-space-or-right-bracket-in-doctype": "预计空间或 '>'. Got '{data}'.",
                "unexpected-end-of-doctype": "DOCTYPE意外结束.",
                "unexpected-char-in-doctype": "在DOCTYPE意外的字符.",
                "eof-in-bogus-doctype": "在假DOCTYPE意外的文件结束.",
                "eof-in-innerhtml": "在内部HTML模式中出现意外EOF.",
                "unexpected-doctype": "意外 DOCTYPE. Ignored.",
                "non-html-root": "HTML需要是第一个开始标记.",
                "expected-doctype-but-got-eof": "意外 文件结束. Expected DOCTYPE.",
                "unknown-doctype": "错误的DOCTYPE。 预期 <!DOCTYPE html>.",
                "quirky-doctype": "新奇的doctype。 预期 <!DOCTYPE html>.",
                "almost-standards-doctype": "几乎标准模式的doctype。 预期 <!DOCTYPE html>.",
                "obsolete-doctype": "过时的文档类型。 预期 <!DOCTYPE html>.",
                "expected-doctype-but-got-chars": "发现非空格字符不首先看到的文档类型。例如预期. <!DOCTYPE html>.",
                "expected-doctype-but-got-start-tag": "启动时不首先看到的DOCTYPE看到标签。例如预期. <!DOCTYPE html>.",
                "expected-doctype-but-got-end-tag": "结束标记没有看到第一次看到一个DOCTYPE。例如预期. <!DOCTYPE html>.",
                "end-tag-after-implied-root": "意外 结束标签 ({name}) 之后 (implied) 根元素.",
                "expected-named-closing-tag-but-got-eof": "意外 文件结束. Expected 结束标签 ({name}).",
                "two-heads-are-not-better-than-one": "预期的开始标记头部现有的头。忽视.",
                "unexpected-end-tag": "意外 结束标签 ({name}). Ignored.",
                "unexpected-implied-end-tag": "结束标签 {name} 隐含的,但也有开放元素.",
                "unexpected-start-tag-out-of-my-head": "意外 开始标签 ({name}) 这可以是在头部.moved.",
                "unexpected-start-tag": "意外 开始标签 ({name}).",
                "missing-end-tag": "Missing 结束标签 ({name}).",
                "missing-end-tags": "Missing 结束标签s ({name}).",
                "unexpected-start-tag-implies-end-tag": "意外 开始标签 ({startName}) implies 结束标签 ({endName}).",
                "unexpected-start-tag-treated-as": "意外 开始标签 ({originalName}). 对待  {newName}.",
                "deprecated-tag": "意外 开始标签 {name}. Don't use it!",
                "unexpected-start-tag-ignored": "意外 开始标签 {name}. Ignored.",
                "expected-one-end-tag-but-got-another": "意外 结束标签 ({gotName}). Missing 结束标签 ({expectedName}).",
                "end-tag-too-early": "结束标签 ({name}) seen too early. Expected other 结束标签.",
                "end-tag-too-early-named": "意外 结束标签 ({gotName}). Expected 结束标签 ({expectedName}.",
                "end-tag-too-early-ignored": "结束标签 ({name}) 看到为时尚早.忽视.",
                "adoption-agency-1.1": "结束标签 ({name}) 结束标签.",
                "adoption-agency-1.2": "结束标签 ({name}) 违反步骤2，采用代理算法的1段.",
                "adoption-agency-1.3": "结束标签 ({name}) 违反步骤3，采用代理算法的1段.",
                "adoption-agency-4.4": "结束标签 ({name}) 违反步骤4，采用代理算法的4段.",
                "unexpected-end-tag-treated-as": "意外 结束标签 ({originalName}). 对待  {newName}.",
                "no-end-tag": "这个元素  ({name}) has no 结束标签.",
                "unexpected-implied-end-tag-in-table": "意外 implied 结束标签 ({name}) in the table phase.",
                "unexpected-implied-end-tag-in-table-body": "意外 implied 结束标签 ({name}) in the table body phase.",
                "unexpected-char-implies-table-voodoo": "表格内容非预期的非空格字符，引发voodoo模式.",
                "unexpected-hidden-input-in-table": "与类突发输入隐藏在表格内容.",
                "unexpected-form-in-table": "表格内容意想不到的形式.",
                "unexpected-start-tag-implies-table-voodoo": "意外 开始标签 ({name}) in table context caused voodoo mode.",
                "unexpected-end-tag-implies-table-voodoo": "意外 结束标签 ({name}) in table context caused voodoo mode.",
                "unexpected-cell-in-table-body": "意外 table cell 开始标签 ({name}) in the table body phase.",
                "unexpected-cell-end-tag": "Got table cell 结束标签 ({name}) while required 结束标签s are missing.",
                "unexpected-end-tag-in-table-body": "意外 结束标签 ({name}) in the table body phase. Ignored.",
                "unexpected-implied-end-tag-in-table-row": "意外 implied 结束标签 ({name}) in the table row phase.",
                "unexpected-end-tag-in-table-row": "意外 结束标签 ({name}) in the table row phase. Ignored.",
                "unexpected-select-in-select": "意外 select 开始标签 in the select phase 对待  select 结束标签.",
                "unexpected-input-in-select": "意外 input 开始标签 in the select phase.",
                "unexpected-start-tag-in-select": "意外 开始标签 token ({name}) in the select phase. Ignored.",
                "unexpected-end-tag-in-select": "意外 结束标签 ({name}) in the select phase. Ignored.",
                "unexpected-table-element-start-tag-in-select-in-table": "意外 table element 开始标签 ({name}) in the select in table phase.",
                "unexpected-table-element-end-tag-in-select-in-table": "意外 table element 结束标签 ({name}) in the select in table phase.",
                "unexpected-char-after-body": "在非预期的非空格字符体阶段之后.",
                "unexpected-start-tag-after-body": "意外 开始标签 token ({name}) in the after body phase.",
                "unexpected-end-tag-after-body": "意外 结束标签 token ({name}) in the after body phase.",
                "unexpected-char-in-frameset": "在框架阶段存在非预期的字符。忽略人物.",
                "unexpected-start-tag-in-frameset": "意外启动标签标记 ({name}) 在框架阶段.忽略.",
                "unexpected-frameset-in-frameset-innerhtml": "意外 结束标签 token (frameset in the frameset phase (innerHTML).",
                "unexpected-end-tag-in-frameset": "意外 结束标签 token ({name}) in the frameset phase. Ignored.",
                "unexpected-char-after-frameset": "在框架阶段后意外的非空格字符。忽视.",
                "unexpected-start-tag-after-frameset": "意外 开始标签 ({name}) in the after frameset phase. Ignored.",
                "unexpected-end-tag-after-frameset": "意外 结束标签 ({name}) in the after frameset phase. Ignored.",
                "expected-eof-but-got-char": "意外的非空格字符。文件结束.",
                "expected-eof-but-got-start-tag": "意外 开始标签 ({name}). Expected 文件结束.",
                "expected-eof-but-got-end-tag": "意外 结束标签 ({name}). Expected 文件结束.",
                "unexpected-end-table-in-caption": "在标题意外结束table标签。隐含生成字幕结束.",
                "end-html-in-innerhtml": "在内部HTML模式中出现意外的HTML结束标记.",
                "eof-in-table": "意外的文件结尾。预计表中的内容.",
                "eof-in-script": "意外的文件结尾。预计脚本内容.",
                "non-void-element-with-trailing-solidus": "尾随斜线不允许元素 {name}.",
                "unexpected-html-element-in-foreign-content": 'HTML标签开始 "{name}" 在国外名称空间上下文.',
                "unexpected-start-tag-in-table": "意外 {name}. 预计表中的内容."
            }
        },
        {}],
        9 : [function(e, t, n) {
        ...
        10 : [function(e, t, n) {
            ...
            function a(e) {
                e ? (this.columnNumber = e.columnNumber, this.lineNumber = e.lineNumber) : (this.columnNumber = -1, this.lineNumber = -1),
            ...
            function v(e, t) {
                a.call(this, e),
                this.data = t,
                this.nodeType = u.COMMENT
            }
            function m(e) {
                f.call(this, e),
                this.nodeType = u.CDATA
            }
            function g(e) {
                f.call(this),
                this.name = e,
                this.nodeType = u.ENTITY
            }
            function y(e) {
                a.call(this),
                this.name = e,
            ...
            s.prototype.getFragment = function() {
                var e = new c;
                return this.reparentChildren(this.openElements.rootNode, e),
                e
            },
            ...
            f.prototype.insertBefore = function(e, t) {
                ...
                e.detach(),
                e.parentNode = this;
                if (this.firstChild == t) e.nextSibling = t,
                this.firstChild = e;
                else {
            ...
            f.prototype.removeChild = function(e) {
                if (this.firstChild == e) this.firstChild = e.nextSibling,
        ...
        13 : [function(e, t, n) {
            ...
            function v(e, t) {
                return ! e || !t ? !1 : Object.prototype.toString.call(t) == "[object RegExp]" ? t.test(e) : e instanceof t ? !0 : t.call({},
                e) === !0 ? !0 : !1
            }
            function m(e, t, n, i) {
                var s;
            ...
            o.AssertionError = function(t) {
                ...
                t.message ? (this.message = t.message, this.generatedMessage = !1) : (this.message = f(this), this.generatedMessage = !0);
        ...
        {}],
        15 : [function(e, t, n) { (function(t, r) {
                function u(e, t) {
                    var r = {
                        seen: [],
                        stylize: f
                ...
                function d(e, t, n, r, i) {
                    var s = [];
                    for (var o = 0,
                    u = t.length; o < u; ++o) H(t, String(o)) ? s.push(v(e, t, n, r, String(o), !0)) : s.push("");
                ...
                function v(e, t, n, r, i, s) {
                    ...
                    H(r, i) || (o = "[" + i + "]"),
                    u || (e.seen.indexOf(a.value) < 0 ? (b(n) ? u = c(e, a.value, null) : u = c(e, a.value, n - 1), u.indexOf("\n") > -1 && (s ? u = u.split("\n").map(function(e) {
                        return "  " + e
                    }).join("\n").substr(2) : u = "\n" + u.split("\n").map(function(e) {
                        return "   " + e
                    ...
                    if (T(o)) {
                        ...
                        o = JSON.stringify("" + i),
                        o.match(/^"([a-zA-Z_][a-zA-Z_0-9]*)"$/) ? (o = o.substr(1, o.length - 2), o = e.stylize(o, "name")) : (o = o.replace(/'/g, "\\'").replace(/\\"/g, '"').replace(/(^"|"$)/g, "'"), o = e.stylize(o, "string"))
                    }
                    return o + ": " + u
                }
                function m(e, t, n) {
        ...
        16 : [function(e, t, n) {
            ...
            r.prototype.emit = function(e) {
                var t, n, r, s, a, f;
                this._events || (this._events = {});
                if (e === "error") if (!this._events.error || o(this._events.error) && !this._events.error.length) throw t = arguments[1],
            ...
            r.prototype.listeners = function(e) {
                var t;
                return ! this._events || !this._events[e] ? t = [] : i(this._events[e]) ? t = [this._events[e]] : t = this._events[e].slice(),
                t
            },
            r.listenerCount = function(e, t) {
                var n;
                return ! e._events || !e._events[t] ? n = 0 : i(e._events[t]) ? n = 1 : n = e._events[t].length,
                n
            }
        },
        {}],
...
ace.define("ace/mode/html_worker", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/worker/mirror", "ace/mode/html/saxparser"],
function(e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
    i = e("../lib/lang"),
